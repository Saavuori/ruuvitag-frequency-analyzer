...
| # | Requirement | State |
|---|---|---|
| F-1 | Resolve components across **1–50 Hz** | **M** — 1.11 to 49.95 Hz at the default settings |
...
- **O-1** Battery life while streaming is neither budgeted nor measured. The tag
  is a bench instrument while connected.
...
- **O-3** Nothing above 50 Hz has been checked against a known source, though
  Nyquist is 190 Hz.
